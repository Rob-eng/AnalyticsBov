...
from app.bot import (
    create_bot_application, start, status, current_analysis, sync_history,
    list_users, start_feedback, receive_feedback, cancel_feedback, 
    handle_keyboard_buttons, WAITING_FEEDBACK
)
...
def main():
    ...
    application.add_handler(MessageHandler(
        filters.Regex("^(📊 Cotação Atual|📈 Status|📥 Importar Histórico|👥 Lista de Usuários)$"),
